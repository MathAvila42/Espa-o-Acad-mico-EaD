...
const FAQ_DATA = [
  {
    ...
    items: [
      ...
      { id: 'va5', q: 'Quais são as datas importantes do semestre?', a: 'Fique atento às datas de início e término das aulas, aos períodos de AP1 e AP2 (provas on-line na plataforma Aula), à data da Avaliação Semestral (AS) presencial e ao prazo para a Avaliação Final (AF). Todas estão no calendário acadêmico EaD.' },
